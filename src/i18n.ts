...
const ko: Dict = {
	...
	"penalty.boo1": "우우~ 😤 그걸 못 넣나요!",
	"penalty.boo2": "키퍼 선방! 아쉽네요~",
	"penalty.boo3": "관중석에서 야유가 쏟아집니다…",
...
const en: Dict = {
	...
	"phase.penalty": "Penalty Shootout",
	...
	"penalty.boo1": "Boo~ 😤 How did you miss that!",
	"penalty.boo2": "Great save by the keeper! So close~",
	"penalty.boo3": "Jeers rain down from the stands…",
...
const ja: Dict = {
	...
	"penalty.boo1": "ブーッ~ 😤 それを外すなんて!",
	"penalty.boo2": "キーパー好セーブ! 惜しい~",
	"penalty.boo3": "スタンドからブーイングの嵐…",
...
const cn: Dict = {
	...
	"penalty.boo1": "嘘~ 😤 这都能踢丢!",
	"penalty.boo2": "门将神扑! 太可惜了~",
	"penalty.boo3": "看台上嘘声一片…",
...
const fr: Dict = {
	...
	"phase.penalty": "Séance de tirs au but",
	...
	"penalty.boo1": "Ouh~ 😤 Comment as-tu pu rater ça !",
	"penalty.boo2": "Superbe arrêt du gardien ! Si près~",
	"penalty.boo3": "Les huées pleuvent des tribunes…",
